...
def update_task_list(args, prev_data_dir, data_dir, prev_output_examples, algo, chunk_size, fix_cls_gen_ratio = None):
    ...
    augment_list = []
    if "augment" in algo:
        augment_list = augment(remain_used, algo[-1])
    # Write list
    write_train_task_list = train_task_list + remain_used + augment_list
...
parser.add_argument('--output_dir', type=str, default="/home/share_folder/allen/263/output/my_experiment/TLAL",
